...
<model ref="r:e04685b0-c14e-4ddf-a7e6-c17a3838833e(io.searchbox.client.config)">
  ...
  <node concept="HxVAC" id="4nFu6$joi3C">
    <property role="wgJFU" value="myModule" />
    <property role="TrG5h" value="Base::ClientConfig" />
    <property role="3GE5qa" value="tmp.basicModularity" />
    <ref role="HxVAF" to="x0nt:7nDaBAKyLlM" resolve="Base" />
    <ref role="HxVAD" node="7nDaBAKzmzZ" resolve="ClientConfig" />
  </node>
  <node concept="HxVAC" id="4nFu6$joi3D">
    <property role="wgJFU" value="myModule" />
    <property role="TrG5h" value="Base::HttpClientConfig" />
    <property role="3GE5qa" value="tmp.basicModularity" />
    <ref role="HxVAF" to="x0nt:7nDaBAKyLlM" resolve="Base" />
    <ref role="HxVAD" node="7nDaBAKzl$W" resolve="HttpClientConfig" />
  </node>
</model>
